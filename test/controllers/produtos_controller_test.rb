...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { ncm: @produto.ncm, produto: @produto.produto, quantidade_minima: @produto.quantidade_minima, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { ncm: @produto.ncm, produto: @produto.produto, quantidade_minima: @produto.quantidade_minima, valor: @produto.valor } }
